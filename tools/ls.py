...
def ls(folder=None):
    ...
    >>> ls()
    'README.md __pycache__ chat.py cmc_csci040_JiyeonKim.egg-info coverage.xml demo.gif dist doctest_examples htmlcov ls.json pyproject.toml reader-whl requirements.txt test_projects tools venv'
