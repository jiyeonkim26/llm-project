...
def repl(temperature=0.0):
    ...
    >>> repl(temperature=0.0)
    chat> /ls
    README.md __pycache__ chat.py cmc_csci040_JiyeonKim.egg-info demo.gif doctest_examples example.txt example_utf16.txt pyproject.toml requirements.txt test_projects tools
    chat> /calculate 2 + 2
    {"result": 4}
